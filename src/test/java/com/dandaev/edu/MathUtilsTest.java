...
public class MathUtilsTest {
	...
	void init() {
		...
		System.out.println("Initializing of test instance ....");
		try {
			Thread.sleep(500);
	...
	void testingArraysEquality() {
		...
		// assertArrayEquals(array_1, array_2, "given two integer arrays should be
		// equal");
	...
	void testingListsEquality() {
		...
		// assertIterableEquals(expected_list_1, actual_list_1, "given two lists should
		// be equal");
	...
	void testingDividerMethod() {
		...
		// если же не будет выброшен ArithmeticException, или будет выброшен Exception
		// отличный от ArithmeticException, тест будет пройден нуспешно
		// assertThrows(ArithmeticException.class, () -> instance_to_test.divider(10,
		// 2), "divide by zero should throw ArithmeticException");
	}
}
